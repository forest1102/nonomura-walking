    ...
    var MainScene = Class.create(Scene, {
        initialize: function () {
          ...
          var backMap = Class.create(Map, {
            ...
            maps = [new TileMap(0), new TileMap(1)],
              ...
              onenterframe: function () {
                ...
                if (this.isMoving) {
                  ...
                  if (this.vx || this.vy) {
                    ...
                    if (0 <= x && x < currentMap.width &&
                      0 <= y && y < currentMap.height &&
                      !currentMap.hitTest(x, y)) {
                      this.isMoving = true;
      ...
      BattleScene = Class.create(Scene, {
        initialize: function () {
          Scene.call(this);
          this.backgroundColor = 'black';
